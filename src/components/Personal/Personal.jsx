...
const Personal = () => {
  return (
    <PersonalWrapper id="personal" bgColor={bgColor3}>
      ...
      <PersonalContent>
        <p>
          I can describe myself as a creative person who gets easily inspired by
          new things (and even simple things) and is excited about meeting new
          people. I always try to be <em>patient to anything in my life</em> and
          keep the <em>positive attitude</em> :)
        </p>
        <p>
          When it comes to hobbies, <em>music</em> takes special place in my
          life. I've been a vocalist in a band for several years, now do
          songwriting by myself and record music at home. I like to{" "}
          <em>travel</em>, but who doesn't? Top-3 things in this topic for me
          are:{" "}
          <em>
            airplanes, discovering new tasty foods, and going to music festivals
          </em>
          !
        </p>
        ...
        <Copyright>
          ...
          <p>Last update: 23 February 2021</p>
          <p>
            <LinkWithIcon
              secondary
