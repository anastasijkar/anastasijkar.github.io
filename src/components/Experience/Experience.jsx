...
import { faNodeJs, faReact, faVuejs } from "@fortawesome/free-brands-svg-icons";
...
const EMPLOYMENT_DATA = [
  ...
  <p><em>Tech stack:</em> HTML5, SCSS, TypeScript, Vue/Vuex, Vuetify, Nuxt, Jest/Enzyme.</p>`,
    link: "https://appchance.com/",
  },
  {
...
const Experience = () => {
    ...
    return (
      ...
      >
        ...
        >
          ...
          <span className="employment-date">{item.time}</span>
  ...
  return (
    <ExperienceWrapper id="experience" bgColor={bgColor2}>
      <h1>Experience</h1>
      <ExperienceList>{employmentList}</ExperienceList>
