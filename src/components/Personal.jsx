    ...
    return (
      <section className="personal">
        ...
        <div className="personal__info">
          <p>I can describe myself as a creative person who gets easily inspired by new things (and even simple things) and excited about meeting new people. I always try to be patient to anything in my life and keep the positive attitude.</p>
