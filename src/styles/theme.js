...
/*export const bgColor1 = '#f8bd76';
export const bgColor2 = '#b26c3e';
export const bgColor3 = '#a0ab44';
export const bgColor4 = '#f8bfb9';
export const textColorSub = '#f9f2e2';
export const textColorMain = '#fff';*/
